//THIS IS NOT MY CODE!! THIS IS FROM THE APCS LIBRARY (linked in README)
...
public class Window extends JApplet {
	...
	private static void initialize() {
		...
		Window.addColor("alice blue", 240, 248, 255);
		Window.addColor("antique white", 250, 235, 215);
		Window.addColor("aqua", 0, 255, 255);
		Window.addColor("aquamarine", 127, 255, 212);
		Window.addColor("azure", 240, 255, 255);
		Window.addColor("beige", 245, 245, 220);
		Window.addColor("bisque", 255, 228, 196);
		Window.addColor("black", 0, 0, 0);
		Window.addColor("blanched almond", 255, 235, 205);
		Window.addColor("blue", 0, 0, 255);
		Window.addColor("blue violet", 138, 43, 226);
		Window.addColor("brown", 139, 69, 19);
		Window.addColor("burlywood", 222, 184, 135);
		Window.addColor("cadet blue", 95, 158, 160);
		Window.addColor("chartreuse", 127, 255, 0);
		Window.addColor("chocolate", 210, 105, 30);
		Window.addColor("coral", 255, 127, 80);
		Window.addColor("cornflower blue", 100, 149, 237);
		Window.addColor("cornsilk", 255, 248, 220);
		Window.addColor("cyan", 0, 255, 255);
		Window.addColor("dark blue", 0, 0, 139);
		Window.addColor("dark cyan", 0, 139, 139);
		Window.addColor("dark goldenrod", 184, 134, 11);
		Window.addColor("dark gray", 169, 169, 169);
		Window.addColor("dark green", 0, 100, 0);
		Window.addColor("dark khaki", 189, 183, 107);
		Window.addColor("dark magenta", 139, 0, 139);
		Window.addColor("dark olive green", 85, 107, 47);
		Window.addColor("dark orange", 255, 140, 0);
		Window.addColor("dark orchid", 153, 50, 204);
		Window.addColor("dark red", 139, 0, 0);
		Window.addColor("dark salmon", 233, 150, 122);
		Window.addColor("dark sea green", 143, 188, 143);
		Window.addColor("dark slate blue", 72, 61, 139);
		Window.addColor("dark slate gray", 47, 79, 79);
		Window.addColor("dark turquoise", 0, 206, 209);
		Window.addColor("dark violet", 148, 0, 211);
		Window.addColor("deep pink", 255, 20, 147);
		Window.addColor("deep sky blue", 0, 191, 255);
		Window.addColor("dim gray", 105, 105, 105);
		Window.addColor("dodger blue", 30, 144, 255);
		Window.addColor("firebrick", 178, 34, 34);
		Window.addColor("floral white", 255, 250, 240);
		Window.addColor("forest green", 34, 139, 34);
		Window.addColor("fuschia", 255, 0, 255);
		Window.addColor("gainsboro", 220, 220, 220);
		Window.addColor("ghost white", 255, 250, 250);
		Window.addColor("gold", 255, 215, 0);
		Window.addColor("goldenrod", 218, 165, 32);
		Window.addColor("gray", 128, 128, 128);
		Window.addColor("grey", 128, 128, 128);
		Window.addColor("green", 0, 128, 0);
		Window.addColor("green yellow", 173, 255, 47);
		Window.addColor("honeydew", 240, 255, 240);
		Window.addColor("hot pink", 255, 105, 180);
		Window.addColor("indian red", 205, 92, 92);
		Window.addColor("indigo", 111, 0, 255);
		Window.addColor("ivory", 255, 255, 240);
		Window.addColor("khaki", 240, 230, 140);
		Window.addColor("lavender", 230, 230, 250);
		Window.addColor("lavender blush", 255, 240, 245);
		Window.addColor("lawn green", 124, 252, 0);
		Window.addColor("lemon chiffon", 255, 250, 205);
		Window.addColor("light blue", 173, 216, 230);
		Window.addColor("light coral", 240, 128, 128);
		Window.addColor("light cyan", 224, 255, 255);
		Window.addColor("light goldenrod", 238, 221, 130);
		Window.addColor("light goldenrod yellow", 250, 250, 210);
		Window.addColor("light gray", 211, 211, 211);
		Window.addColor("light green", 144, 238, 144);
		Window.addColor("light pink", 255, 182, 193);
		Window.addColor("light salmon", 255, 160, 122);
		Window.addColor("light sea green", 32, 178, 170);
		Window.addColor("light sky blue", 135, 206, 250);
		Window.addColor("light slate blue", 132, 112, 255);
		Window.addColor("light slate gray", 119, 136, 153);
		Window.addColor("light steel blue", 176, 196, 222);
		Window.addColor("light yellow", 255, 255, 224);
		Window.addColor("lime", 0, 255, 0);
		Window.addColor("lime green", 50, 205, 50);
		Window.addColor("linen", 250, 240, 230);
		Window.addColor("magenta", 255, 0, 255);
		Window.addColor("maroon", 128, 0, 0);
		Window.addColor("medium aquamarine", 102, 205, 170);
		Window.addColor("medium blue", 0, 0, 205);
		Window.addColor("medium orchid", 186, 85, 211);
		Window.addColor("medium purple", 147, 112, 219);
		Window.addColor("medium sea green", 60, 179, 113);
		Window.addColor("medium slate blue", 123, 104, 238);
		Window.addColor("medium spring green", 0, 250, 154);
		Window.addColor("medium turquoise", 72, 209, 204);
		Window.addColor("medium violet red", 199, 21, 133);
		Window.addColor("midnight blue", 25, 25, 112);
		Window.addColor("mint cream", 245, 255, 250);
		Window.addColor("misty rose", 255, 228, 225);
		Window.addColor("moccasin", 255, 228, 181);
		Window.addColor("navajo white", 255, 222, 173);
		Window.addColor("navy", 0, 0, 128);
		Window.addColor("old lace", 253, 245, 230);
		Window.addColor("olive", 128, 128, 0);
		Window.addColor("olive drab", 107, 142, 35);
		Window.addColor("orange", 255, 165, 0);
		Window.addColor("orange red", 255, 69, 0);
		Window.addColor("orchid", 218, 112, 214);
		Window.addColor("pale goldenrod", 238, 232, 170);
		Window.addColor("pale green", 152, 251, 152);
		Window.addColor("pale turquoise", 175, 238, 238);
		Window.addColor("pale violet red", 219, 112, 147);
		Window.addColor("papaya whip", 255, 239, 213);
		Window.addColor("peach puff", 255, 218, 185);
		Window.addColor("peru", 205, 133, 63);
		Window.addColor("pink", 255, 192, 203);
		Window.addColor("plum", 221, 160, 221);
		Window.addColor("powder blue", 176, 224, 230);
		Window.addColor("purple", 128, 0, 128);
		Window.addColor("red", 255, 0, 0);
		Window.addColor("rosy brown", 188, 143, 143);
		Window.addColor("royal blue", 65, 105, 225);
		Window.addColor("saddle brown", 139, 69, 19);
		Window.addColor("salmon", 250, 128, 114);
		Window.addColor("sandy brown", 244, 164, 96);
		Window.addColor("sea green", 46, 139, 87);
		Window.addColor("seashell", 255, 245, 238);
		Window.addColor("sienna", 160, 82, 45);
		Window.addColor("silver", 192, 192, 192);
		Window.addColor("sky blue", 135, 206, 235);
		Window.addColor("slate blue", 106, 90, 205);
		Window.addColor("slate gray", 112, 128, 144);
		Window.addColor("snow", 255, 250, 250);
		Window.addColor("spring green", 0, 255, 127);
		Window.addColor("steel blue", 70, 130, 180);
		Window.addColor("tan", 210, 180, 140);
		Window.addColor("teal", 0, 128, 128);
		Window.addColor("thistle", 216, 191, 216);
		Window.addColor("tomato", 255, 99, 71);
		Window.addColor("turquoise", 64, 224, 208);
		Window.addColor("violet", 238, 130, 238);
		Window.addColor("violet red", 208, 32, 144);
		Window.addColor("wheat", 245, 222, 179);
		Window.addColor("white", 255, 255, 255);
		Window.addColor("white smoke", 245, 245, 245);
